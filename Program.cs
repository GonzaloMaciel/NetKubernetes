...
var mapperConfig = new MapperConfiguration(MvcCoreMvcBuilderExtensions => {
    MvcCoreMvcBuilderExtensions.AddProfile(new InmuebleProfile());
});
...
var identityBuider = new IdentityBuilder(builderSecurity.UserType, builder.Services);
identityBuider.AddEntityFrameworkStores<AppDbContext>();
